...
- `read <alias> [-f|--full] [-r|--raw]` — entity content; body truncated unless `-f`. `-r` dumps raw FtM JSON. The header prints the entity's Aleph url, for linking in your write-up.
