...
/// Aleph-query and local-cache subcommands. Each opens its own Store /
/// AlephClient lazily — the CLI is short-lived, no point keeping them
/// around. (Export lives in Commands/Export.swift.)
